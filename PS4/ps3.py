...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        pos_x = math.floor(pos.get_x())
        pos_y = math.floor(pos.get_y())
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        pos_x = random.uniform(0,room.width)
        pos_y = random.uniform(0,room.height)
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        """
        x = math.floor(pos.get_x()) ### BURAYI DÜZELT####################################################################################################
        y = math.floor(pos.get_y())
        return x >= 0 and y >= 0 and x < self.width and y < self.height and (int(pos.get_x()), int(pos.get_y())) not in self.furniture_tiles
    ...
    def get_random_position(self):
        ...
        while (int(x),int(y)) in self.furniture_tiles:
            x,y = random.uniform(0,self.width), random.uniform(0,self.height)        
        return Position(x,y)
